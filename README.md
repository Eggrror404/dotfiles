...
- GTK
  ...
  and the symlinks stow create (with relative paths) doesn't seem to get along with the flatpak sandbox, so you may have to manaully copy the files over, or create symlinks with _absolute path_ (and remember to add this dotfiles directory to the allow list).
